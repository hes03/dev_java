package ch02;
// 클래스 내부에서 코딩을 한다.
// 자바에서는 8가지 타입을 제공한다. - int(4byte), long(8byte-64)
// int와 long은 모두 정수를 담을 수 있는데 담을 수 있는 값의 크기 차이가 있다.
// 윈도우를 32bit로 설치하면 램을 8GB밖에 사용 못함.
...
public class Variable2 {
    ...
    public static void main(String[] args) {
        ...
        //사용한 후에 다시 사용되지 않으면 캔디데이트 상태로 체크했다가
        //가비지 컬렉터가 회수 함.
        ...
        //전역변수를 호출하려면 변수이름 앞에 인스턴스 변수명.닷트연산자 붙이고 호출함
        //인스턴스화에 사용된 변수 v2를 인스턴스변수라고 한다.
        v2.empno = 8000;
        System.out.println(v2.empno); //처음에 0 출력됨. 재정의하면 8000. 전변은 초기화를 생략할 수 있고 디폴트값은 0이다.
    }
}
