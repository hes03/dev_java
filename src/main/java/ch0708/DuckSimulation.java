...
public class DuckSimulation {
    public static void main(String[] args) {
        ...
        // -> 그러면 생성부에 여러타입을 선택할 수 있다.
        // -> 코드를 수정할 때 최소한의 수정을 보장함.
        Duck myDuck = new MalladDuck();
        myDuck.display();//나는 청둥오리입니다.
        myDuck.fly();//나는 날고있어요
        Duck himDuck = new WoodDuck();
        himDuck.fly(); //나는 날지 못합니다.
        himDuck.display(); //나는 나무오리입니다.
    }
}
//같은 이름의 메서드이지만 구현체 클래스에 따라 기능이 달라진다 - 다형성
//선언부 타입과 생성부 타입이 다르면 기대할 수 있다
