...
public class MemberDao {
    ...
    //물리적으로 떨어져 있는 오라클 서버에 세션을 연결함
    Connection con = null;
    //개발자가 작성한 select문 전달하고 요청함
    PreparedStatement pstmt = null;
    //아래는 오라클의 cursor를 추상화환 인터페이스임
    ResultSet rs = null;
    /*
    ...
    * @return MemberVo[] - 객체배열
    ...
    public MemberVO[] getMemberList(String mem_id){
        ...
        try {
            ...
            //3. 연결객체를 통해서 쿼리문을 전달하고 오라클에게 select문 처리를 요청함
            ...
            //이렇게 하는 이유는 배열의 원소의 갯수를 개발자가 알 수 없기 때문
            ...
            //문제제기 : 배열안에는 null만 세개 있다.
            //회원에 대한 정보는 Vector안에는 들어있다.
